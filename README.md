...
PET样品（2.80 mg）在N₂/O₂/N₂分段气氛下以30°C升温至700°C，呈现典型的两步分解模式：

| 失重段 | 温度范围 | DTG峰温 | 峰速率 | 质量损失 | 归属物质/反应 |
|--------|----------|---------|---------|----------|---------------|
| Ⅰ | 303–480°C | 430.6°C | –15.91%/min | –84.92% | PET主链热裂解（N₂氛围） |
| Ⅱ | 500–680°C | 572.2°C | –3.19%/min | –14.44% | 残炭氧化燃烧（O₂氛围） |
| 终态 | 700°C | — | — | 残留≈0% | 无无机残留 |
...
- **第Ⅱ段（残炭氧化，572.2°C）**：第Ⅰ段裂解后残留约13.5%的含碳焦炭（芳香环缩聚产物），气氛切换为O₂后发生完全氧化燃烧，产物为CO₂和H₂O。终态残留量接近0%，证明PET为纯有机材料，不含无机填料，与FTIR原样谱中无无机特征峰相印证。
### 2.3 FTIR 分析
![](images/image_1.png)
![](images/image_2.png)
...
蜜雪冰城塑料袋（2.41 mg）在N₂/O₂/N₂气氛下以30°C升温至900°C，呈现明显的五段失重过程，反映出多组分体系的复杂性：
...
| Ⅳ | 470–600°C | 523.7°C | –2.08%/min | –12.02% | 残炭氧化燃烧（O₂氛围） |
...
- **第Ⅳ段（炭氧化，523.7°C）**：气氛切换为O₂后，前几段产生的含碳焦炭发生氧化燃烧，损失−12%。
...
可降解塑料袋1号（8.40 mg）在N₂/O₂/N₂气氛下以23°C升温至900°C，呈现四段失重过程：

| 失重段 | 温度范围 | DTG峰温 | 峰速率 | 质量损失 | 归属物质/反应 |
|--------|----------|---------|---------|----------|---------------|
| Ⅰ | 356–430°C | 390.3°C | –9.39%/min | –52.82% | PBAT主链酯键热裂解（N₂氛围） |
| Ⅱ | 430–500°C | 455.5°C | –2.63%/min | –9.95% | 芳香族硬段（PBT片段）二次裂解 |
| Ⅲ | 500–650°C | 537.1°C | –1.81%/min | –9.17% | 残炭氧化燃烧（O₂氛围） |
...
- **第Ⅲ段（炭氧化，537.1°C）**：气氛切换为O₂后，前两段裂解产生的焦炭发生氧化燃烧，损失−9%。
...
可降解塑料袋2号（8.55 mg）在N₂/O₂/N₂气氛下以23°C升温至900°C，呈现三段失重过程：

| 失重段 | 温度范围 | DTG峰温/拐点 | 峰速率 | 质量损失 | 归属物质/反应 |
|--------|----------|---------|---------|----------|---------------|
| Ⅰ | RT–418°C | 拐点 418.3°C | 缓慢失重 | –20.27% | OBE助剂+淀粉类添加剂分解 |
| Ⅱ | 418–500°C | 457.6°C | –10.53%/min | –55.65% | HDPE主链C–C热裂解（N₂氛围） |
